...
#include "turtle_catcher_interfaces/msg/detail/turtle__rosidl_typesupport_fastrtps_c.h"
...
using _Turtle__ros_msg_type = turtle_catcher_interfaces__msg__Turtle;
...
static uint32_t _Turtle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtle_catcher_interfaces__msg__Turtle(
...
{
  return max_serialized_size_turtle_catcher_interfaces__msg__Turtle(
    full_bounded, 0);
}
