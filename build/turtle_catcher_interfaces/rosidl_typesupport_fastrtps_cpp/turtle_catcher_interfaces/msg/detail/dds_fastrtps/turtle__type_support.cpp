...
#include "turtle_catcher_interfaces/msg/detail/turtle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtle_catcher_interfaces::msg::Turtle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_catcher_interfaces::msg::Turtle & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
...
{
  auto typed_message =
    static_cast<const turtle_catcher_interfaces::msg::Turtle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_catcher_interfaces::msg::Turtle *>(
    untyped_ros_message);
...
{
  return &turtle_catcher_interfaces::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_catcher_interfaces, msg, Turtle)() {
  return &turtle_catcher_interfaces::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
