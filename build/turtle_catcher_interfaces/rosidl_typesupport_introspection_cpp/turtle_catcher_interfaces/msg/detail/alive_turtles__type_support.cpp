...
{
  new (message_memory) turtle_catcher_interfaces::msg::AliveTurtles(_init);
}

void AliveTurtles_fini_function(void * message_memory)
{
  auto typed_message = static_cast<turtle_catcher_interfaces::msg::AliveTurtles *>(message_memory);
  typed_message->~AliveTurtles();
}

size_t size_function__AliveTurtles__alive_turtles(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<turtle_catcher_interfaces::msg::Turtle> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<turtle_catcher_interfaces::msg::Turtle> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<turtle_catcher_interfaces::msg::Turtle> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AliveTurtles_message_member_array[1] = {
  {
    ...
    offsetof(turtle_catcher_interfaces::msg::AliveTurtles, alive_turtles),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AliveTurtles_message_members = {
  "turtle_catcher_interfaces::msg",  // message namespace
  "AliveTurtles",  // message name
  1,  // number of fields
  sizeof(turtle_catcher_interfaces::msg::AliveTurtles),
...
{
  return &::turtle_catcher_interfaces::msg::rosidl_typesupport_introspection_cpp::AliveTurtles_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_catcher_interfaces, msg, AliveTurtles)() {
  return &::turtle_catcher_interfaces::msg::rosidl_typesupport_introspection_cpp::AliveTurtles_message_type_support_handle;
}
