...
static const _AliveTurtles_type_support_symbol_names_t _AliveTurtles_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_catcher_interfaces, msg, AliveTurtles)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtle_catcher_interfaces, msg, AliveTurtles)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtle_catcher_interfaces, msg, AliveTurtles)() {
  return &::turtle_catcher_interfaces::msg::rosidl_typesupport_c::AliveTurtles_message_type_support_handle;
}
